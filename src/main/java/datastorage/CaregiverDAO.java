...
public class CaregiverDAO extends DAOimp<Caregiver> {
    ...
    protected String getCreateStatementString(Caregiver caregiver) {
        return String.format("INSERT INTO caregiver (firstname, surname, telnumber, active) VALUES ('%s', '%s', '%s', '%s')",
                caregiver.getFirstName(), caregiver.getSurname(), caregiver.getTelnumber(), caregiver.getActive());
    }
    ...
    protected String getUpdateStatementString(Caregiver caregiver) {
        return String.format("UPDATE caregiver SET firstname = '%s', surname = '%s', telnumber = '%s', active = '%s' " +
                        "WHERE cid = %d", caregiver.getFirstName(), caregiver.getSurname(), caregiver.getTelnumber(),
                caregiver.getActive(), caregiver.getCid());
    }
